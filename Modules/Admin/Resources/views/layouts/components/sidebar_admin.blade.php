...
|| Route::is('vai-tro.index') || Route::is('ngay-nghi.index') || Route::is('sao-luu-du-lieu.index') || Route::is('nhat-ky-truy-cap.index')
 || Route::is('email-don-vi-ngoai-he-thong.index') ? 'active menu-open' : '' }} }} ">
    ...
    <ul class="treeview-menu">
        ...
        <li class="{{ Route::is('email-don-vi-ngoai-he-thong.index') ? 'active' : '' }}"><a href="{{ route('email-don-vi-ngoai-he-thong.index') }}"><i class="fa fa-circle-o"></i>Email đơn vị ngoài hệ thống</a></li>
