<li class="treeview {{ Route::is('van-ban-di.index') || Route::is('van-ban-di.create') || Route::is('van-ban-di.edit') ||
 Route::is('danh_sach_vb_di_cho_duyet') || Route::is('vb_di_da_duyet') ? 'active menu-open' : '' }} }} ">
    <a href="#">
...
<li class="treeview {{ Route::is('bao_cao_thong_ke.index') ||  Route::is('thong-ke-cap-duoi-lanh-dao.index')   ? 'active menu-open' : '' }} ">
    <a href="#">
