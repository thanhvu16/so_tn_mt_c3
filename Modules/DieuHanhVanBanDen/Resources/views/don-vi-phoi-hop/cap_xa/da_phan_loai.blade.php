            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="col-md-12" style="margin-top: 20px">
                        <div class="row">
                            <form action="{{route('van-ban-phoi-hop.da_phan_loai')}}" method="get">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @if (!empty(Request::get('trich_yeu')) || !empty(Request::get('so_den')) ||
                                        ...
                                        <a href="{{ route('van-ban-phoi-hop.da_phan_loai', 'chuyen_tiep=1') }}" class="btn btn-success"><i
                                    ...
                                    <td>
                                        <p>
                                            <textarea name="noi_dung_chu_tich[{{ $vanBanDen->id }}]"
                                                      form="form-tham-muu"
                                                      class="form-control noi-dung-chu-tich {{ !empty($vanBanDen->phoChuTich) ? 'show' : 'hide' }}"
