...
@section('page_title', 'Văn bản chỉ đạo - giám sát')
@section('content')
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="header-title pt-2">Văn bản chỉ đạo - giám sát</h4>
                            </div>
                        </div>
                    </div>
                    <div class="box-body">
                        <form action="@if(Request::get('type') == 1){{route('giay-moi-den-don-vi.xem_de_biet')}}@else{{route('van-ban-den-don-vi.xem_de_biet')}}@endif" method="get">
                            <div class="row">
                                <div class="col-md-4">
                                                ...
                                                @if (isset($vanBanDen->vanBanDi->filechinh))
                                                    ...
                                                    @foreach($vanBanDen->vanBanDi->filechinh as $key => $file)
                                                        <a href="{{ $file->getUrlFile() }}"
                                                           target="popup"
                                                           class="detail-file-name seen-new-window">[{{ $file->ten_file ?? 'file-tai-lieu' }}
                                                            ]</a>
