            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive">
                        <form action="@if(Request::get('type') == 1){{route('giay-moi-den-don-vi.quan_trong')}}@else{{route('van-ban-den-don-vi.quan_trong')}}@endif" method="get">
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @if(request('han_xu_ly') || request('trich_yeu') || request('so_den'))
                                        <a href="{{ route('van-ban-den-don-vi.quan_trong') }}">
