...
@section('page_title', 'Thêm giấy mời đi')
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form class="form-row"
                              action="{{ route('luuGiayMoiNhapSoDi')}}"
...
{{--                            </div>--}}
                            ...
                            <div class="form-group col-md-3">
                                <label for="sokyhieu" class="col-form-label">Số đi <span style="color: red">*</span></label>
                                <input type="number" value="{{$soDi}}"
                                       name="so_di"  class="form-control" style="font-weight: 800;color: #F44336;"
                                       required>
                            </div>
                            <div class="form-group col-md-3">
