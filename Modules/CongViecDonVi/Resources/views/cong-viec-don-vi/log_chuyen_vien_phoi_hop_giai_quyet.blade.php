@if (!empty($danhSachPhoiHopGiaiQuyet) && count($danhSachPhoiHopGiaiQuyet) > 0)
    <div class="row mt-2">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card-box box-panel">
            <div class="table-responsive">
                <h3>
                    <a data-toggle="collapse" href="#chuyen-vien-phoi-hop-giai-quyet" class="color-black">
                        <i class="fas fa-link"></i> CV chuyên viên phối hợp đã giải quyết
