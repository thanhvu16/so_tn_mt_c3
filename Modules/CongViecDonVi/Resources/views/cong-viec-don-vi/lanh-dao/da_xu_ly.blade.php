                                    ...
                                    <table class="table table-striped table-bordered dataTable table-hover data-row">
                                        ...
                                        @forelse($danhSachCongViecDonVi as $congViecDonVi)
                                            <tr class="tr-tham-muu">
                                                ...
                                                <td>
                                                    @if ($congViecDonVi->ChuyenNhanCongViecDonViDaXuLy)
                                                        @foreach($congViecDonVi->ChuyenNhanCongViecDonViDaXuLy as $key => $dauViecDonVi)
                                                            <p>
                                                                <b>- Đơn vị chủ
                                                            ...
                                                            @if (count($congViecDonVi->ChuyenNhanCongViecDonViDaXuLy)-1 != $key)
