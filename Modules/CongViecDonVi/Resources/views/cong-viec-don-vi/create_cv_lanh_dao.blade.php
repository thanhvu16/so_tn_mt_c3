...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h4 class="header-title mb-2">Tạo công việc</h4>
                <div class="card-box pd-0">
                    <div class="tab-content pd-0">
                        <div class="tab-pane active">
                            <form action="{{ route('soan-bao-cao.store') }}" method="post" enctype="multipart/form-data" class="form-row">
                                @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="don_vi_phoi_hop[]" id="don-vi-phoi-hop"
                                                            class="form-control don-vi-phoi-hop select2-search"
                                                            multiple
                                ...
                                <div class="col-md-12 mt-2 text-center">
                                    <div class="row">
                                        <div class="col-md-12 mb-2">
                                            ...
                                            <a href="{{ route('chi_dao_dieu_hanh.index') }}" title="hủy"
