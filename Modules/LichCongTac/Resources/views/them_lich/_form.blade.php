<div class="col-md-10">
    <div class="modal fade" id="them-moi-lich-hop{{ isset($lichCongTac) ? '-'.$lichCongTac->id : null }}" role="dialog" aria-labelledby="exampleModalLabel">
...
{{--                                                {{ !empty($lichCongTac->vanBanDenDonVi->noi_dung_hop) ? $lichCongTac->vanBanDenDonVi->noi_dung_hop :  !empty($lichCongTac->vanBanDenDonVi->vb_trich_yeu) ? $lichCongTac->vanBanDenDonVi->vb_trich_yeu : null  }}--}}
                            ...
                            <div class="row mt-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" required="" value="{{ isset($lichCongTac) ? $lichCongTac->ngay : date('d/m/Y') }}" class="form-control" name="ngay" placeholder="dd/mm/yyyy">
                                </div>
