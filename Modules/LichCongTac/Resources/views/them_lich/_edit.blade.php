<form
    action="{{ isset($lichCongTac) ? route('lich-cong-tac.update', $lichCongTac->id) : route('lich-cong-tac.store') }}"
    ...
    <div class="modal-header" style="padding: 12px; background: #daf7f5;">
        ...
        <h4 class="modal-title text-bold" id="exampleModalLabel">#{{ isset($lichCongTac) ? 'Cập nhật ': 'Thêm ' }} lịch
            họp tuần</h4>
    </div>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <textarea class="form-control" rows="3" required="" name="noi_dung"
                              placeholder="Nội dung">{{ isset($lichCongTac) ? $lichCongTac->noi_dung : '' }}</textarea>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-sm-6">
                    ...
                    <input type="date" required=""
                           value="{{ isset($lichCongTac) ? $lichCongTac->ngay : date('d/m/Y') }}" class="form-control"
                           name="ngay">
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        <input type="text" required class="form-control time-picker-24h"
                               value="{{ isset($lichCongTac) ? $lichCongTac->gio : '' }}" name="gio">
            ...
            <div class="row mt-3">
                <div class="col-sm-6">
                    ...
                    <input type="text" name="dia_diem" placeholder="Nhập địa điểm" class="form-control"
                           value="{{ isset($lichCongTac) ? $lichCongTac->dia_diem : null }}" required>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row mt-3">
                <div class="col-sm-3">
                    <div class="radio-info form-check-inline">
                        <input type="radio" name="trang_thai_lich"
                               id="chinh-thuc{{ isset($lichCongTac) ? $lichCongTac->id : null }}" value="1"
                               checked {{ isset($lichCongTac) && $lichCongTac->trang_thai_lich == 1 ? 'checked' : '' }}>
                        <label for="chinh-thuc{{ isset($lichCongTac) ? $lichCongTac->id : null }}">Lịch chính
                            thức</label>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="radio-info form-check-inline">
                        <input type="radio" name="trang_thai_lich"
                               id="lich-hoan{{ isset($lichCongTac) ? $lichCongTac->id : null }}"
                               value="2" {{ isset($lichCongTac) && $lichCongTac->trang_thai_lich == 2 ? 'checked' : '' }}>
                ...
                <div class="col-sm-3">
                    <div class="radio-info form-check-inline">
                        <input type="radio" name="trang_thai_lich"
                               id="lich-dieu-chinh{{ isset($lichCongTac) ? $lichCongTac->id : null }}"
                               value="3" {{ isset($lichCongTac) && $lichCongTac->trang_thai_lich == 3 ? 'checked' : '' }}>
                        <label for="lich-dieu-chinh{{ isset($lichCongTac) ? $lichCongTac->id : null }}">Lịch điều
                            chỉnh</label>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="radio-info form-check-inline">
                        <input type="radio" name="trang_thai_lich"
                               id="lich-phat-sinh{{ isset($lichCongTac) ? $lichCongTac->id : null }}"
                               value="4" {{ isset($lichCongTac) && $lichCongTac->trang_thai_lich == 4 ? 'checked' : '' }}>
                        <label for="lich-phat-sinh{{ isset($lichCongTac) ? $lichCongTac->id : null }}">Lịch phát
                            sinh</label>
                    </div>
                </div>
            </div>
            <div
                ...
                <div class="col-sm-12">
                    ...
                    <textarea name="ghi_chu" rows="4" class="form-control noi-dung-ghi-chu"
                              placeholder="ghi chú">{{ isset($lichCongTac) ? $lichCongTac->ghi_chu : '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
