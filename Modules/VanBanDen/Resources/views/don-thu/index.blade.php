...
@section('page_title', 'Danh sách đơn thư')
@section('content')
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <div class="col-md-6">
                            <div class="row">
                                <h3 class="box-title">Danh sách đơn thư khiếu nại</h3>
                            </div>
                        </div>
...
{{--                                    <span style="color: white;font-size: 14px"><i class="fa fa-folder-open-o"></i> Tải nhiều tệp tin</span></a>--}}
                                <a class=" btn btn-primary" data-toggle="collapse"
                                   ...
                                   aria-expanded="false" aria-controls="collapseExample"> <i class="fa  fa-search"></i> <span
                                        style="font-size: 14px">Tìm kiếm</span>
                                </a>
                            </div>
{{--                                <div class="col-md-6 text-right">--}}
...
{{--                                @endcan--}}
                    ...
                    <div class="col-md-12 ">
                        <div class="row">
                            ...
                            <div class="col-md-12 collapse {{ Request::get('search') == 1 || Request::get('year') ? 'in' : '' }} " id="collapseExample">
                                <form action="{{route('don-thu-khieu-lai.index')}}" id="tim_kiem" method="get" >
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3" >
                                                <label for="sokyhieu" class="col-form-label">Mã đơn</label>
                                            ...
                                            <div class="form-group col-md-12" >
                                                <label for="sokyhieu" class="col-form-label ">Nội dung đơn thư</label>
                    ...
                    <div class="box-body" style=" width: 100%;overflow-x: auto;">
                        Tổng số đơn thư khiếu nại: <b style="font-size: 16px">{{ $ds_vanBanDen->total() }}</b>
                        <table class="table table-bordered table-striped dataTable mb-0">
                            ...
                            <tr>
                                ...
                                <th width="" style="vertical-align: middle" class="text-center">Nội dung</th>
                                <th width="10%" style="vertical-align: middle" class="text-center">Thông tin công dân</th>
                            ...
                            @forelse ($ds_vanBanDen as $key=>$vbDen)
                                <tr >
                                    ...
                                    <td>
                                    <p>- Mã đơn: {{$vbDen->so_ky_hieu}}</p>
                                    <p>- Ngày tiếp nhận: {{ date('d/m/Y', strtotime($vbDen->ngay_ban_hanh)) }}</p>
                                    </td>
                                    ...
                                    <td class="text-left">{{$vbDen->thong_tin_cong_dan}}</td>
                                    <td>
                                        <!--vb den don vi-->
                                        @if ($vbDen->parent_id)
