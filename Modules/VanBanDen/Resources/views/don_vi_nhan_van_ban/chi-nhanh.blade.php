                        ...
                        <div class="row">
                            <div class="col-md-12" >
                                <div class="col-md-6" style="margin-top: 5px">
                                    Tổng số văn bản: <b>{{ count($vanbanhuyenxuongdonvi) }}</b>
                                </div>
                                <div class="col-md-6 text-right">
                                    {!! $vanbanhuyenxuongdonvi->appends(['so_van_ban_id' => Request::get('so_van_ban_id'),'loai_van_ban_id' => Request::get('loai_van_ban_id'), 'vb_so_den' => Request::get('vb_so_den')
