                        ...
                        <form class="form-row"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="so_ky_hieu"
                                       value="{{ old('vb_so_ky_hieu', isset($vanban) ? $vanban->vanbandi->so_ky_hieu : '') }}"
                                       required autofocus
                            ...
                            <div class="form-group col-md-3" id="div_select_cqbh">
                                ...
                                <input type="text" value="{{isset($vanban)? $vanban->donViGuiDen($vanban->vanbandi->phong_phat_hanh)->ten_don_vi : ''}}"
                                       class="form-control"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control"
                                           value="{{$vanban->vanbandi->dia_diem}}"
                        ...
                        <i class="fa fa-plus"></i> thêm nội dung</span>
                            ...
                            <div class="col-md-3" >
                                <label for="sokyhieu" class="col-form-label">Người ký <span
                                        class="color-red">*</span></label>
                                <input type="text" class="form-control "
                                       value="{{isset($vanban) ? $vanban->vanbandi->nguoidung2->ho_ten : ''}}" required
                                       name="nguoi_ky_id">
                            </div>
                            <div class="col-md-3" >
                            ...
                            <div class="col-md-12 form-group" style="margin-top: 10px">
                                <div class="row increment ">
                                    <div class="col-md-3 mt-4" >
                                        ...
                                        <span>
                                    @if($vanban->vanbandi->filechinh)
                                                @forelse($vanban->vanbandi->filechinh as $key=>$item)
