        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="{{ isset($loaivb_email) && $loaivb_email->ten_loai_van_ban == 'Giấy mời' ? route('luuGiayMoiMail') : route('luuvanbantumail') }}" method="post" enctype="multipart/form-data"
                          id="myform">
                        @csrf
                        <div class="box-body">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="so_ky_hieu" id="exampleInputEmail4"
                                           placeholder="Số ký hiệu" value="{{empty($data_xml) ? '': $data_xml->STRKYHIEU}}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        <input type="text" class="form-control vanbantrung ngay-ban-hanh datepicker" value=" {{ !empty($data_xml) ? date('d/m/Y', strtotime($data_xml->STRNGAYKY)) : '' }}" name="ngay_ban_hanh" id="exampleInputEmail5"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{empty($data_xml) ? '': $data_xml->STRNOIGUI}}" name="co_quan_ban_hanh" id="exampleInputEmail6"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="trich_yeu" rows="3" required>{{empty($data_xml) ? $email->mail_subject:$data_xml->STRTRICHYEU}}</textarea>
                                </div>
                            </div>
                            @if( $loaivb_email)
