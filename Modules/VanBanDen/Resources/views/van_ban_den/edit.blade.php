        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="{{route('van-ban-den.update',$van_ban_den->id)}}" method="post" enctype="multipart/form-data"
                          id="myform">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" autofocus name="loai_van_ban" required>
                                        ...
                                        @foreach($loaivanban as $loaivanbands)
                                            <option value="{{ $loaivanbands->id }}"{{ $van_ban_den->loai_van_ban_id == $loaivanbands->id ? 'selected' : '' }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 check-so-den-vb" data-don-vi="{{auth::user()->don_vi_id}}" name="so_van_ban" required>
                                        ...
                                        @foreach($sovanban as $data)
                                            <option value="{{ $data->id }}" {{ $van_ban_den->so_van_ban_id == $data->id ? 'selected' : '' }}>{{ $data->ten_so_van_ban }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$van_ban_den->so_ky_hieu}}" name="so_ky_hieu" id="exampleInputEmail4"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" value="{{$van_ban_den->ngay_ban_hanh}}" name="ngay_ban_hanh" id="exampleInputEmail5"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$van_ban_den->co_quan_ban_hanh}}" name="co_quan_ban_hanh" id="exampleInputEmail6"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$van_ban_den->nguoi_ky}}" name="nguoi_ky" id="exampleInputEmail7"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2"  name="lanh_dao_tham_muu" required>
                                        ...
                                        @foreach($users as $nguoidung)
                                            <option value="{{ $nguoidung->id }}" {{ $van_ban_den->lanh_dao_tham_muu == $nguoidung->id ? 'selected' : '' }}>{{ $nguoidung->ho_ten }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="trich_yeu" rows="3" required>{{$van_ban_den->trich_yeu}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 collapse @if($van_ban_den) @if($van_ban_den->noi_dung != null)show @endif @else in @endif "
                                 id="collapseExample">
