                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <a class="btn btn-default waves-effect waves-light btn-sm" role="button"
                                ...
                                <div class="col-md-12 ">
                                    <H4 style="text-align: center;font-weight: bold">BÁO CÁO THỐNG KÊ TỔNG HỢP SỐ LIỆU
                                        CHỈ ĐẠO VÀ GIẢI QUYẾT VĂN BẢN</H4><br>
                                    <h5 style="font-weight: bold">- Thời
                                        gian: {{Request::get('tu_ngay')}} @if(Request::get('tu_ngay') && Request::get('den_ngay') )
                                            đến @endif  {{Request::get('den_ngay')}}<br><br>
                                ...
                                <div class="col-md-12" style="margin-top: 5px">
                                    <table class="table table-bordered table-striped dataTable mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" style="vertical-align: middle" rowspan="2" width="">
                                                Đơn vị
                                            </th>
                                            <th class="text-center" style="vertical-align: middle" rowspan="2"
                                                width="10%">Tổng số văn bản
                                            </th>
                                            <th class="text-center" style="vertical-align: middle" colspan="2"
                                                width="20%">Số văn bản đã giải quyết
                                            </th>
                                            <th class="text-center" style="vertical-align: middle" colspan="2"
                                                width="20%">Số văn bản chưa giải quyết
                                            </th>
                                        </tr>
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center so-luong-tong"
                                                    ...
                                                    <input type="text" class="soVB hidden"
                                                           value="{{ $donVidata->vanBanDaGiaiQuyet['tong'] }}">
                                                </td>
                                                ...
                                                <td class="text-center" style="vertical-align: middle"><a
                                                        href="{{route('chiTietDaGiaiQuyetTrongHanVanBanChiCuc',$donVidata->id.'?tu_ngay='.Request::get('tu_ngay').'&den_ngay='.Request::get('den_ngay'))}}">
                                                        {{ $donVidata->vanBanDaGiaiQuyet['giai_quyet_trong_han'] }}</a>
                                                </td>
                                                <td style="vertical-align: middle;text-align: center">
                                                    <a href="{{route('chiTietDaGiaiQuyetQuaHanVanBanChiCuc',$donVidata->id.'?tu_ngay='.Request::get('tu_ngay').'&den_ngay='.Request::get('den_ngay'))}}">
                                                        {{ $donVidata->vanBanDaGiaiQuyet['giai_quyet_qua_han'] }}</a>
                                                </td>
                                                <td style="vertical-align: middle;text-align: center"><a
                                                        href="{{route('chiTietChuaGiaiQuyetTrongHanVanBanChiCuc',$donVidata->id.'?tu_ngay='.Request::get('tu_ngay').'&den_ngay='.Request::get('den_ngay'))}}">
                                                        {{ $donVidata->vanBanDaGiaiQuyet['chua_giai_quyet_giai_quyet_trong_han'] }}
                                                    </a></td>
                                                <td style="vertical-align: middle;text-align: center">
                                                    <a href="{{route('chiTietChuaGiaiQuyetQuaHanVanBanChiCuc',$donVidata->id.'?tu_ngay='.Request::get('tu_ngay').'&den_ngay='.Request::get('den_ngay'))}}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><span class="tongSo text-center"
