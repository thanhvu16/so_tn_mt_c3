...
@section('page_title', 'In sổ văn bản đến')
@section('content')
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">In sổ văn bản đến</h3>
                    </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <form action="{{route('in-so-van-ban-den.index')}}" method="get">
                                ...
                                <div class="col-md-8 text-right">
                                    <form action method="GET" action="{{ route('in-so-van-ban-den.index') }}" class="form-export">
                                ...
                                <div class="col-md-12" style="margin-top: 5px">
                                    <table class="table table-bordered table-striped dataTable mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">Số đến
                                            </th>
                                        ...
                                        <tbody>
                                        @forelse ($ds_vanBanDen as $key=>$vbDi)
                                            <tr>

                                                <td class="text-center" style="vertical-align: middle"> {{$key+1}}</td>
                                                <td class="text-center" style="vertical-align: middle">{{ date('d-m-Y', strtotime($vbDi->ngay_ban_hanh))}}</td>
                                                <td class="text-center" style="vertical-align: middle"><span style="color: red">{{ $vbDi->so_den}}</span></td>
