...
use App\Models\Filecanbogopyduthaongoai;
use App\User;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\SoftDeletes;

class CanBoPhongDuThaoKhac extends Model
{

    protected $table = 'dtvb_y_kien_du_thao_phong_khac';
    use SoftDeletes;
    ...
    public function gopyFilecanbophongngoai()
    {
        return $this->hasMany(\Modules\VanBanDi\Entities\Filecanbogopyduthaongoai::class, 'can_bo_gop_y', 'id')->where('trang_thai',1);
    }
