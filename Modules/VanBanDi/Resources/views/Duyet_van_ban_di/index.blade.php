                                        ...
                                        @forelse($vanbandichoduyet as $key=>$vanban)
                                            <form action="{{route('duyetvbditoken')}}" method="post">
                                                ...
                                                <tr class="duyet-gia-han">
                                                    ...
                                                    <td>
                                                        @if(!empty($vanban->vanbandi) && $userAuth->id == $vanban->vanbandi->nguoiky_id)
                                                            ...
                                                            <div class="col-md-12 form-group">
                                                                <div class="row">
                                                                    <select name="nguoi_nhan" id=""
                                                                        ...
                                                                        @if(!empty($vanban->vanbandi) && in_array($vanban->vanbandi->nguoiky_id, $idcuanguoinhan->toArray()))
                                                                            <option
                                                                                value="{{$vanban->vanbandi->nguoiky_id}}"
                                                                            >{{ $vanban->vanbandi->nguoidung2->ho_ten ?? '' }}</option>
                                                                        @else
                                                                            @forelse ($nguoinhan as $data)
                                                                                <option
                                                                                    value="{{ $data->id }}" {{ isset($data) && !empty($vanban->vanbandi) && $data->id == $vanban->vanbandi->nguoiky_id ? 'selected ' : '' }}
                                                                                >{{ $data->ho_ten}}</option>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <button
                                                            ...
                                                            <i class="fas fa-share"></i> Duyệt
                                                        </button><br>
                                                        @endif

                                                        <button
                                                            class="btn waves-effect btn-danger btn-choose-status btn-sm"
                                                            name="submit_tralai" value="2" data-type="2"><i class="fas fa-redo-alt"></i> Trả lại
                                                        </button>
