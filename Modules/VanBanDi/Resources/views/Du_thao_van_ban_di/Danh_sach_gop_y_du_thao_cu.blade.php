                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped dataTable mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="75"> Ngày dự thảo

                                            </th>
                                            <th class="text-center" width="45">Ký hiệu

                                            </th>
                                            <th class="text-center" width="400">Trích yếu

                                            </th>
                                            <th class="text-center" width="50">File</th>
                                            <th class="text-center" width="260">Ý kiến</th>
