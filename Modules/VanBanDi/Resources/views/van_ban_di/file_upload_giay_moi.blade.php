            ...
            <ul class="nav nav-tabs o-tab">
                <li class="nav-item">
                    <a href="#home" data-toggle="tab" aria-expanded="false" class="nav-link active">
                        <i class="far fa-plus-square"></i> File giấy mời đi
                    </a>
                </li>
            </ul>
                ...
                <div class="tab-content pd-0">
                    <div class="tab-pane active" id="home">
                        ...
                        <div class="col-md-12" style="padding-top: 10px">
                            <form method="post" action="{{route('upload_motfile_giay_moi_di')}}" enctype="multipart/form-data"
                                  autocomplete="off"
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped dataTable mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="{{route('delete_motfile_di',$data->id)}}"
                                                                   style="color: red">
