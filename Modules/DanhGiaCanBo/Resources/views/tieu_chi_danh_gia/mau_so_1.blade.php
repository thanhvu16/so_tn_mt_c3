                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row" style="margin-bottom: 10px">
                            <div class="col-md-6">
                                <form action="{{route('danh-gia-can-bo.index')}}" method="get">
                                    <select
                        ...
                        <form action="{{route('danh-gia-can-bo.store')}}" method="post">
                            @csrf
                            ...
                            <table id="" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th width="10%" class="text-center vertical">Điểm phó phòng</th>
                                    <th width="10%" class="text-center vertical">Điểm trưởng phòng</th>

                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <th class="text-center vertical" style="font-weight: bold">I</th>
                                    <th style="font-weight: bold">Ý THỨC TỔ CHỨC KỶ LUẬT</th>
                                ...
                                <tr>
                                    ...
                                    <th class="vertical text-center" style="vertical-align: middle">
                                        ...
                                        @else
                                            <span
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_2 : ''}}</span>
                                        @endif
                                    </th>
                                    <th class="vertical text-center"
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_3 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_4 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_5 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <th class="vertical text-center" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_6 : ''}}</h4>
                                        @endif
                                    </th>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_7 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_8 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{ isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_9 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_10 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_11 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_12 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    <th class="text-center vertical" style="font-weight: bold">II</th>
                                    <th style="font-weight: bold">KẾT QUẢ THỰC HIỆN NHIỆM VỤ</th>
                                    ...
                                    <th class="vertical text-center" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_13 : ''}}</h4>
                                        @endif
                                    </th>
                                    <th class="vertical text-center"
                                    ...
                                    <th class="vertical text-center" style="vertical-align: middle">
                                        @if(empty($laydanhgiacanhan))
                                            <input type="text" name="tong_canhan_nangluc"
                                                   readonly=""
                                                   value="20"
                                                   class="form-control tong_3 tinhlai">
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_14 : ''}}</h4>
                                        @endif
                                    </th>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_15 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_16 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_17 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_18 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_19 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_20 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_21 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_22 : ''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_23 : ''}}</h4>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_24 :''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <th class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_25 : ''}}</h4>
                                        @endif
                                    </th>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    <th class="text-center vertical" style="font-weight: bold">III</th>
                                    ...
                                    <th class="vertical text-center" style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ?$laydanhgiacanhan->laychitietdanhgia->field_26:''}}</h4>
                                        @endif
                                    </th>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <td class="vertical " style="vertical-align: middle">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{ isset($laydanhgiacanhan) ?$laydanhgiacanhan->laychitietdanhgia->field_27:''}}</h4>
                                        @endif
                                    </td>
                                    <th class="vertical text-center"
                                ...
                                <tr>
                                    ...
                                    <th class="vertical text-center">
                                        ...
                                        @else
                                            <h4 style="font-size: 16px"
                                                class="text-center">{{isset($laydanhgiacanhan) ? $laydanhgiacanhan->laychitietdanhgia->field_28: ''}}</h4>
                                        @endif
                                    </th>
                                    <th class="vertical text-center"
                            ...
                            @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <button name="luulai" value="1" class="btn btn-primary pull-right "
                                                    data-original-title="" title=""><i class="fa  fa-send-o"></i> Đánh
                                                giá
                                            </button>
                                        </div>
                                    </div>
