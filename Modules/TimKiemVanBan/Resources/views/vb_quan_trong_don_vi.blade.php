                    ...
                    <div class="col-md-12 mt-3">
                        <div class="row">
                            ...
                            <div class="col-md-12 collapse {{ Request::get('search') == 1 || Request::get('year') ? 'in' : '' }} " id="collapseExample">
                                <form action="{{route('vanBanLanhDaoSoqt')}}" id="tim_kiem" method="get" >
                                        <div class="row">
                    ...
                    <div class="box-body" style=" width: 100%;overflow-x: auto;">
                        ...
                        <table class="table table-bordered table-striped dataTable mb-0">
                            ...
                            <tr>
                                ...
                                <th width="7%" style="vertical-align: middle" class="text-center">Số đến</th>
                                <th width="16%" style="vertical-align: middle" class="text-center">Thông tin</th>
                                <th width="20%"  style="vertical-align: middle"class="text-center">Cơ quan ban hành</th>
