                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped dataTable mb-0" >
                            ...
                            <tbody>
                            @forelse($ds_vb_hoso as $key=>$data)
                                ...
                                <tr>
                                    @if($data->loai_van_ban == 2)
                                        ...
                                        <td style="vertical-align: middle;">{{$data->vanbandi->nguoitao->donvi->ten_don_vi ?? ''}}</td>
                                    ...
                                    @else
                                        <td class="text-center"
                                            style="vertical-align: middle;">{{$key+1}}</td>
                                        <td>
                                            <p>- Văn bản đến số: <span class="color-red">{{ $data->vanBanDen->so_den }}</span></p>
                                        ...
                                        <td style="vertical-align: middle;">{{$data->vanBanDen->co_quan_ban_hanh ?? ''}}</td>
                                        <td class="text-center" style="vertical-align: middle;">
                                            <a href="{{route('delete_tailieuhs',$data->id)}}"
                                               class="btn btn-action btn-color-red btn-icon btn-ligh btn-sm btn-remove-item"
                                               role="button" title="Xóa">
