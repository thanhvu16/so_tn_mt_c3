                                ...
                                <table class=" table-bordered table-striped dataTable mb-0">
                                    ...
                                    @forelse($thongtincanhancham as $key=>$data)
                                        <form action="{{route('danhgiacaptren')}}" method="post">
                                            @csrf
                                            <tbody>
                                            @if($data->trang_thai == 2 && Auth::user()->vai_tro == 2)
                                                <tr>
                                            ...
                                            @else
                                                ...
                                                <tr style="text-align: justify">
                                                    ...
                                                    <td colspan="9">
                                                        {{--                                                    {{isset($laydanhgiaphophong) ? 'Nhận xét của cấp phó : '. $laydanhgiaphophong->nhan_xet : ''}} --}}
                                                        @if(($data->trang_thai == 3 || $data->trang_thai == 4) && Auth::user()->vai_tro == 3)
                                                ...
                                                @if((Auth::user()->vai_tro == 3 )&& ($data->trang_thai == 2))
                                                    <tr>
                                                        <td colspan="22" style="vertical-align: middle;">
...
{{--                                                                    </option>--}}
                                                ...
                                                @elseif ((Auth::user()->vai_tro == 2 )&& ($data->trang_thai == 3))
                                                    <tr>
                                                        <td colspan="22" style="vertical-align: middle;">
