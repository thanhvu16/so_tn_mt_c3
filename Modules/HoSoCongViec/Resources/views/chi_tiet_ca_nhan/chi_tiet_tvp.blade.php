...
@section('page_title', 'Chi tiết cán bộ ')
                ...
                <ul class="nav nav-tabs o-tab">
                    <li class="nav-item">
                        <a href="#home" data-toggle="tab" aria-expanded="false" class="nav-link active">
                            <i class="fas fa-user-check"></i><span style="font-size: 16px"> Điểm chi tiết cán bộ</span>
                        </a>
                    </li>
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin: 10px 0px;">
                                        <div class="col-md-12">
                                            ...
                                            <tr>
                                                <th class="text-center vertical"></th>
                                                <th class="text-center">Điểm Chánh Văn Phòng</th>
                                                <th colspan="4" class="text-center vertical">

                                                    <b style="color: red">{{isset($laydanhgiatranhvanphong) ?$laydanhgiatranhvanphong->xep_loai : ''}}</b>
